...
public class ManaDistillerMenu extends AbstractContainerMenu {
    ...
    public ManaDistillerMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public ManaDistillerMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.MANA_DISTILLER_MENU.get(), id);
        checkContainerSize(inv, 3);
        blockEntity = (ManaDistillerBlockEntity) entity;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.MANA_DISTILLER.get());
    }
